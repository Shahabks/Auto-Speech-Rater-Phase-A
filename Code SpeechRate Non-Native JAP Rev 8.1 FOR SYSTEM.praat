	...
	if avenumberofwords<=3.14 and avenumberofwords>=2.67  
	 ...
	 if originaldur>=60
		warning1$ = "No warning"
				...
				warning1$ = "your speech lasts in less than 60 seconds; it might affect the accuracy of your pronunciation assessment"
	 endif
...
Erase all
	 ...
	 ... ,"PRONUNCIATION", newline$										
  	 ...
  	 ... ,"------------------------------------------------------------------------", newline$
   	 ...
   	 ... , w$, newline$
   	 ... ,'pron',tab$, tab$, 'prom',tab$, tab$,'ffff', tab$, tab$,'eeee', tab$, tab$,'inpro', tab$, tab$,'f1norm',"*********************************************************", newline$
