...
Erase all
         ...
         appendInfoLine: "FILE NAME", newline$
	 ... ,"*************************************************************************", newline$
	 ... ,'rstd:1', tab$,'zstd:1', tab$,'qstd:1', tab$,'lstd:1', tab$,'ostd:1', tab$,'wstd:1',newline$
	 ... ,'xx:1', tab$,xxban$, newline$
	 ... ,"*************************************************************************", newline$
	 ... ,"1st PRONUNCIATION", newline$										
   	 ... ,"2nd INTONATION and STRESS", newline$									
   	 ... ,"3rd FLUENCY in SPEECH", newline$			
   	 ... ,"4th STRUCTURE*", newline$					
   	 ... ,"5th COHERENCE and COMPREHENSIBILITY", newline$							 
   	 ... ,"6th IDEAS DEVELOPMENT", newline$	
	 ... ,"7th TOEFL score bar chart****", newline$	
	 ... ,"8th CEFR score bar chart****", newline$	
   	 ... ,"*********************************************************", newline$
endfor
